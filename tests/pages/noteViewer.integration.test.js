...
describe('Note Viewer Integration Tests', () => {
    ...
    describe('Interactions Panel', () => {
        it('should parse and display note interactions', () => {
            ...
            interactionsContainer.innerHTML = comments.map((comment, index) => {
                const actionLabel = comment.action === 'opened' ? 'Created' :
                    comment.action === 'commented' ? 'Commented' :
                    comment.action === 'closed' ? 'Closed' :
                    comment.action === 'reopened' ? 'Reopened' : comment.action;
            ...
            expect(firstInteraction.querySelector('.interaction-text').textContent).toContain('#surveyme');
            ...
            expect(secondInteraction.querySelector('.interaction-text').textContent).toContain('#invalid');
        });
        ...
        it('should display empty state when no interactions', () => {
            ...
            expect(interactionsContainer.querySelector('.no-interactions').textContent).toBe('No interactions yet');
        });
