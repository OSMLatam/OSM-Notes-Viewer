...
Complete guide to install all dependencies and set up OSM-Notes-Viewer for development and
production.
...
**No server-side dependencies required** - The Viewer is a static web application that can be
deployed to:
...
**Note**: The Viewer is a static web application. Node.js is only needed for development (testing,
building, formatting).
...
The Viewer is configured to use OSM-Notes-Data by default. No configuration is required for
production.
