...
description: "All data is served as static JSON files generated by the OSM-Notes-Analytics backend. The viewer fetches these files directly without any API server."
version: "1.0.0"
...
[AUTHENTICATION_STRATEGY.md](AUTHENTICATION_STRATEGY.md#🛡️-protección-del-lado-del-cliente-viewer)
for details.
