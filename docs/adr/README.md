...
This directory contains Architecture Decision Records (ADRs) for OSM-Notes-Viewer.
...
- [ADR-0002](0002_Use_Static_Web_Application.md): Use Static Web Application
- [ADR-0003](0003_Consume_JSON_From_Separate_Repository.md): Consume JSON from Separate Repository
